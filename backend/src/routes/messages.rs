...
use std::sync::Arc;
use crate::AppState;
use crate::handlers::messages::{get_messages, delete_message, get_mention_suggestions, update_message};
...
pub fn message_routes(state: Arc<AppState>) -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route("/channel/{channel_id}/mentions", get(get_mention_suggestions))
