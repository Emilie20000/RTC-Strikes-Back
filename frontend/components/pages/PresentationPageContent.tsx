  ...
  return (
    <div className="h-screen w-screen bg-background text-foreground flex flex-col overflow-hidden">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-8 relative">
        ...
        <div key={currentSlide} className="flex flex-col items-center gap-4 mb-12 text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div key={`content-${currentSlide}`} className="flex-1 flex items-center justify-center w-full animate-in zoom-in-95 duration-500 delay-100">
